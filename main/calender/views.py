...
with open('client_secret.json') as user_file:
  client_contents = user_file.read()
...
# you should set this to `http://localhost:8080/oauth2callback`.
...
def index(request):
    return JsonResponse({"message": "Welcome to the covin Assignment!"})
